...
- Non verbeux (utilise peu de signes pour représenter la structure du texte).  
...
[La documentation](https://stylo-doc.ecrituresnumeriques.ca/fr/) et des [tutos en vidéo](https://video.mshparisnord.fr/c/stylo/videos). 
...
2. Reprenez le texte de Catulle vu plus haut, il se trouve aussi [ici](https://scaife.perseus.org/reader/urn:cts:latinLit:phi0472.phi001.perseus-lat2:5) ; 
